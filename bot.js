...
// MUTE
 ...
 const unmuteembedsucces = new Discord.RichEmbed().setColor(config.embedcolor).setDescription(config.unmutesuccesfully);
    ...
    if (message.content.startsWith(config.prefix + 'mute')) {
        if(!message.member.roles.find("name", config.adminmuterole))
...
if (message.content.startsWith(config.prefix + 'kick')) {
    if(!message.member.roles.find("name", config.adminkickrole))
...
if (message.content.startsWith(config.prefix + 'ban')) {
    if(!message.member.roles.find("name", config.adminbanrole))
